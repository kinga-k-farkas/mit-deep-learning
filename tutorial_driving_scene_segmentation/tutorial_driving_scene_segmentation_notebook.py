...
# %% {"cellView": "code", "colab": {"base_uri": "https://localhost:8080/", "height": 35.0}, "colab_type": "code", "id": "kAbdmRmvq0Je", "outputId": "f82ca270-f776-41b7-c542-dbf02116015c"}
# Tensorflow
...
# %% [markdown] {"colab_type": "text", "id": "OQ4WfdFGKLSc"}
# ### Build the model
#
...
# %% {"colab": {}, "colab_type": "code", "id": "ixa_Cty2KLSc"}
...
# %% [markdown] {"colab_type": "text", "id": "q0QhB_7SKLSf"}
# ### Visualization
...
# %% [markdown] {"colab_type": "text", "id": "pzxbIveNKLSi"}
...
# %% {"colab": {"base_uri": "https://localhost:8080/", "height": 70.0}, "colab_type": "code", "id": "c4oXKmnjw6i_", "outputId": "19f93d51-1e69-4b7d-b9b5-16affad308b2"}
...
# %% {"colab": {"base_uri": "https://localhost:8080/", "height": 304.0}, "colab_type": "code", "id": "edGukUHXyymr", "outputId": "68858de4-7d6f-464c-bfed-b576a2843ea3"}
...
# %% [markdown] {"colab_type": "text", "id": "mnrA2FABKLSp"}
# ### Run on the sample video
# The sample video is frame #0 to #597 in the MIT DriveSeg Dataset.

# %% {"colab": {"base_uri": "https://localhost:8080/", "height": 521.0}, "colab_type": "code", "id": "oXTrq3DgKLSp", "outputId": "de91e86a-1b2a-43d9-cd3d-42a0bd92320b"}
...
# %% [markdown] {"colab_type": "text", "id": "o_FjC5CNKLSr"}
# ### Evaluation
# Now let's evaluate the model performance with the ground truth annotation. First read the annotation from a tar file.

# %% {"colab": {"base_uri": "https://localhost:8080/", "height": 304.0}, "colab_type": "code", "id": "yIxt5IvCKLSr", "outputId": "ffec8782-d7c7-4370-975f-dec9e4e0f86e"}
...
# %% [markdown] {"colab_type": "text", "id": "PaDegfu-KLSu"}
...
# %% {"colab": {"base_uri": "https://localhost:8080/", "height": 141.0}, "colab_type": "code", "id": "c2E4PMGRKLSu", "outputId": "9ac55399-1490-4d25-be56-267a0457739a"}
...
# %% [markdown] {"colab_type": "text", "id": "dN_NN_KVKLSw"}
# ### Evaluate on the sample video

# %% {"colab": {"base_uri": "https://localhost:8080/", "height": 159.0}, "colab_type": "code", "id": "YXqR6Vv7KLSw", "outputId": "9bd3a60e-164a-4d43-a258-718e8b8e176e"}
...
# %% [markdown] {"colab_type": "text", "id": "qbiDYrpCKLSy"}
...
# %% {"colab": {"base_uri": "https://localhost:8080/", "height": 159.0}, "colab_type": "code", "id": "3CstN0dKKLS0", "outputId": "af17a11a-09ac-4f16-b75d-8aa8c65f25f4"}
...
# %% [markdown] {"colab_type": "text", "id": "s9ReH8nAKLS2"}
# Can you make it better?

# %% [markdown] {"colab_type": "text", "id": "mAUptUM1KLS2"}
# ## Acknowledgements
#
